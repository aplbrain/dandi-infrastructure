...
module "api_heroku" {
  ...
  config_vars = {
    ...
    DJANGO_CORS_ALLOWED_ORIGINS        = join(",", ["https://dandi.emberarchive.org", "https://medit.dandiarchive.org", "https://neurosift.app"])
